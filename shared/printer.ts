...
export function generateZPL(printJob: PrintJob): string {
  ...
  epcs.forEach((epc, index) => {
    ...
    zpl += '^FO00,180^GFA,3200,3200,20,,::::::::::::::::::::::::::::::::::::::::::::::::Y018,Y07E,X01FF8,X07FFE,W01JF8,W07JFE,V01LFC,V0IFE7IF,U03IF81IFC,U07FFE007FFE,U07FF8001FFE,U07FEJ07FE,U07FL0FE,U07CL03E,U07N0E,U04N02,,:U06N06,U078L01E,U07EL07E,U07F8J01FE,U07FFJ07FE,U07FFC003FFE,U03IF00IFC,U01IFC3IF8,V07LFE,V01LF8,W03JFE,X0JF,X03FFC,Y0FF,Y03C,,::::::O01FF01FFE00FFC01FF01FE,O07FFC1IF01FFE07FF07FF8,O0603E1E0FC3C0E0F870F8FC,R0E1C03C38001E001E01E,R0F1C01E38003C003C00E,R071C00E3C0038003800F,O01IF1C00E1FC0380078007,O03IF1C0070FF838007I07,O0780F1C00F03FE38007I07,O0F0071C00E003E380078007,O0E0071C00EI0F38003800F,O0E0071C01EI073C003C00E,O0F0071C03CI0F1E001E03E,O07E3F1F0F8381E0F830FCFC,O03IF1IF07FFC07FF07FF,P0FFC1FFC01FF001FF01FC,S01C,:::::,::::::::::::::::::::::::::::::::::::::::::::::::^FS\n';
